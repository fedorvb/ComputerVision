...
def svm_loss_vectorized(W, X, y, reg):
  ...
  loss = 0.0
  dW = np.zeros(W.shape) # initialize the gradient as zero
  #if X is None or W is None or y is None or reg is None:
  #    return loss, dW
  num_train = X.shape[0]    
  delta = 1.0
  #############################################################################
  ...
  #print "Shape correct_class_score.shape:", correct_class_score.shape
  #print "correct_class_score[:, np.newaxis].shape:", correct_class_score[:, np.newaxis].shape
  #print "scores.shape:", scores.shape  
  Loss = scores - correct_class_score[:, np.newaxis] + delta   
  margins = np.maximum(0, Loss)
